...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/parcelles/import', [ParcelleController::class, 'importForm'])->name('parcelles.import')->middleware('permission:import-parcelles');
    Route::post('/parcelles/import', [ParcelleController::class, 'import'])->name('parcelles.import.store')->middleware('permission:import-parcelles');
    ...
    Route::delete('/parcelles/{parcelle}', [ParcelleController::class, 'destroy'])->name('parcelles.destroy')->middleware('permission:delete-parcelles');
    ...
    Route::get('/users/{user}', [UserController::class, 'show'])->name('users.show')->middleware('permission:manage-users');
