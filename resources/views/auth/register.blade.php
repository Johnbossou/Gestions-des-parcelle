...
<head>
    ...
    <title>Inscription - Gestion Parcelles</title>
...
<body>
    ...
    <div class="register-card glass">
        <div class="card-header">
            ...
            <p class="card-subtitle">Créez votre compte sécurisé</p>
        </div>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="input-field @error('name') error @enderror" placeholder="Votre nom" required aria-describedby="name-error">
                    </div>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" class="input-field @error('password_confirmation') error @enderror" placeholder="••••••••" required aria-describedby="password_confirmation-error">
                    </div>
