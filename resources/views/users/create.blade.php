            ...
            <div class="form-section">
                ...
                <div class="form-group roles-group">
                    ...
                    <div class="roles-options">
                        @foreach(['Administrateur', 'Superviseur_administratif', 'Consultant', 'Chef_Administratif', 'Directeur'] as $role)
                        <label class="role-option">
                            <input type="radio" name="role" value="{{ $role }}" {{ old('role') == $role ? 'checked' : '' }} class="role-input" required>
                            <div class="role-card">
                                <div class="role-icon">
                                    ...
                                    @elseif($role === 'Superviseur_administratif')
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                    </svg>
                                    @elseif($role === 'Chef_Administratif')
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="role-details">
                                    <span class="role-title">{{ str_replace('_', ' ', $role) }}</span>
                                    <span class="role-description">
                                        @if($role === 'Administrateur')
                                        Gestion des utilisateurs
                                        @elseif($role === 'Superviseur_administratif')
                                        Gestion des total des parcelles
                                        @elseif($role === 'Chef_Administratif')
